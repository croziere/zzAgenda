...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9' => 'get1Ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9Service',
            '2_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9' => 'get2Ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9Service',
        ...
        $this->privates = array(
            '1_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9' => true,
            '2_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9']) ? $this->services['1_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9'] : $this->get1Ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9']) ? $this->services['2_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9'] : $this->get2Ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c1edbec187604948f44c8b1748a52c3b3c4e381cc77f863fe752778468d63cac');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('244175f0d04c046939bf85141572ea0e32be171a');
    }
    ...
    /**
     * Gets the private '1_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1Ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9Service()
    {
        return $this->services['1_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2Ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9Service()
    {
        return $this->services['2_ec2c9839d290ba0392ca05542006e3a0ca863516f59f00b9e0f09ed3c6a07fc9'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('RVYlUGh42W', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w8cVQFcJi-', 0, 'xhuaBY9Jp+8qOzh61mJL1x', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FVVyU5lRW-', 0, 'xhuaBY9Jp+8qOzh61mJL1x', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qAukTVb3TW', 0, 'xhuaBY9Jp+8qOzh61mJL1x', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59c929ded806b2.90614009');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '244175f0d04c046939bf85141572ea0e32be171a',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '244175f0d04c046939bf85141572ea0e32be171a',
